...
from app import app
from apps import data_input, hazard_analysis, explosion_calculator, vent_calculator, incident_map, table, t_squared, mesh_size, HGL_temp, steel_heating, react_balance, flame_size, H2_plume
...
def display_page(pathname):
    ...
    elif pathname == '/apps/H2_plume':
        return H2_plume.layout
    else:
